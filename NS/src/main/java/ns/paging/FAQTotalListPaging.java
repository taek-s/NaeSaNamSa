...
@Component(value = "faqTotalListPaging")
public class FAQTotalListPaging {
	// 공통 적용
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/help/faqList?searchType="
		...
		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append("<li class='page-item active'><a class='page-link' href='"
						+ "/ns/help/faqList?searchType=" + searchType + "&pg=" + i + "&keyword=" + keyword + "'>" + i + "</a></li>");
			} else {
				pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/help/faqList?searchType="
