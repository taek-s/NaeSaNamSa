...
@Component(value = "adminCSTotalListPaging")
public class AdminCSTotalListPaging {
	// 공통 적용
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/admin/csList?searchType="
		...
		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append(
						"<li class='page-item active'><a class='page-link' href='" + "/ns/admin/csList?searchType="
