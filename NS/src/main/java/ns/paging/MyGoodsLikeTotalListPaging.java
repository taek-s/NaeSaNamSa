...
@Component(value="myGoodsLikeTotalListPaging")
public class MyGoodsLikeTotalListPaging {
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/myShop/goodsLikeList?"
					+ "pg=" + (startPage - 1) + "'><span aria-hidden='true'>&laquo;</span></a></li>");

		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append("<li class='page-item active'><a class='page-link' href='"
						+ "/ns/myShop/goodsLikeList?" + "pg=" + i + "'>" + i + "</a></li>");
			} else {
				pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/myShop/goodsLikeList?"
						+ "pg=" + i + "'>" + i + "</a></li>");
			}
		...
		if (endPage < totalP) {
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/myShop/goodsLikeList?"
					+ "pg=" + (endPage + 1) + "'><span aria-hidden='true'>&raquo;</span></a></li>");
		}
