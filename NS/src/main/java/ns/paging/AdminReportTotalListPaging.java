...
@Component(value="adminReportTotalListPaging")
public class AdminReportTotalListPaging {
	// 공통 적용
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/admin/reportList?searchType="
		...
		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append(
						"<li class='page-item active'><a class='page-link' href='" + "/ns/admin/reportList?searchType="
		...
		if (endPage < totalP) {
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/admin/reportList?searchType="
					+ searchType + "&pg=" + (endPage + 1) + "&keyword=" + keyword
