...
@Component(value = "reportTotalListPaging")
public class ReportTotalListPaging {
	// 공통 적용
	...
	public void makePagingHTML() {
		...
		if (startPage > pageBlock)
			pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/myPage/reportList?pg="
		...
		for (int i = startPage; i <= endPage; i++) {
			if (i == currentPage) {
				pagingHTML.append("<li class='page-item active'><a class='page-link' href='"
						+ "/ns/myPage/reportList?pg=" + i + "'>" + i + "</a></li>");
			} else {
				pagingHTML.append("<li class='page-item'><a class='page-link' href='/ns/myPage/reportList?pg=" + i
						+ "'>" + i + "</a></li>");
			}
