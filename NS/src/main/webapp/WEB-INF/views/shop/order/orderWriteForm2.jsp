       ...
       class="needs-validation" novalidate>
        ...
        <div class="row flex-column">
          ...
          <table class="table">
            ...
            <tbody>
              <tr>
                <th scope="row">${goods.GOODS_TITLE}</th> <!-- GOODS_TITLE -->    <!-- el로!!! -->
                <td><fmt:formatNumber value="${goods.GOODS_PRICE }" type="number"/></td> <!-- ORDERS_PRICE -->
                <td><fmt:formatNumber value="${goods.GOODS_PRICE }" type="number"/></td> <!-- ORDERS_TCOST -->
              </tr>
            </tbody>
          </table>
        </div>
...
$(document).ready(function() {
	...
	function fn_order() {
		...
		comSubmit.addParam("ORDERS_DCOST", "0");
		comSubmit.addParam("ORDERS_TCOST", ${goods.GOODS_PRICE});
		comSubmit.addParam("ORDERS_DZIPCODE", "00000");										
		comSubmit.addParam("ORDERS_DADD1", "직거래");
		comSubmit.addParam("ORDERS_DADD2", "직거래");
		comSubmit.addParam("ORDERS_DMEMO", "직거래");
