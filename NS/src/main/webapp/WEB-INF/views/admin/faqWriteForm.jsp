    ...
    <div class="container p-5">
	  ...
	  <div class="row mb-4">
		...
		<div class="form-floating">
		  <textarea class="form-control" id="FAQ_CONTENT" name="FAQ_CONTENT" style="height: 350px" required></textarea>
	  ...
	  <div class="row mb-4 justify-content-center">
	  	<div class="col-12 text-end">
		  	<button class="btn btn-primary me-md-2" type="button" name="adminFAQWrite">등록</button>
...
$(document).ready(function() {
	...
	function fn_adminFAQWrite() {
		var comSubmit = new ComSubmit("faqForm");
		comSubmit.setUrl("/ns/admin/faqWrite");
		comSubmit.submit();
	};
	...
	(() => {
	 ...
	 $("button[name='adminFAQWrite']").on("click", function(e) {  // 관리자 FAQ 작성
		e.preventDefault();
