    ...
    <div class="container p-5">
	  ...
	  <div class="row mb-4">
		...
		<div class="form-floating">
		  <textarea class="form-control" id="NOTICE_CONTENT" name="NOTICE_CONTENT" style="height:350px" required></textarea>
	  ...
	  <div class="row mb-4 justify-content-center">
	  	<div class="col-12 text-end">
		  	<button class="btn btn-primary me-md-2" type="button" name="adminNoticeWrite">등록</button>
...
$(document).ready(function() {
	...
	function fn_adminNoticeWrite() {
		var comSubmit = new ComSubmit("noticeForm");
		comSubmit.setUrl("/ns/admin/noticeWrite");
	...
	(() => {
	  ...
	  $("button[name='adminNoticeWrite']").on("click", function(e) {  // 관리자 공지사항 작성
		e.preventDefault();
