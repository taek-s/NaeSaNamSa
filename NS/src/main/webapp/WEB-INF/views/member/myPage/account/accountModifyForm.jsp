...
<script>
  ...
  <body>
    <div class="container text-start pt-5 pb-5">
      ...
      <form id="accountModifyForm" action="/ns/myPage/accountModify" method="POST" class="needs-validation" novalidate>
        ...
        <div class="row justify-content-end mt-5">
          <button type="submit" class="btn btn-secondary col-2 me-3" name="accountModify">
            회원 정보 수정
          </button>
